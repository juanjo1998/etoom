...
class PaymentMethodCreatePremium extends Component
{

      /* una vez escuchado el evento, desencadenamos una accion */
      protected $listeners = ['paymentMethodCreatePremium'];
      ...
      public function paymentMethodCreatePremium($paymentMethod)
      {
      ...
      public function render()
      {
        ...
        return view('livewire.payment-method-create-premium',[
