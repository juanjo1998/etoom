<div>
    <article class="card relative">
        ...
        <div wire:loading.flex="paymentMethodCreatePremium" class="justify-center items-center 
        ...
        <form id="card-form">
            ...
            <div class="card-footer bg-gray-50 flex justify-end">
                <button
                  ...
                  wire:target="paymentMethodCreatePremium"   
            ...
            function stripe(){
                ...
                cardForm.addEventListener('submit', async (e) => {
                    ...
                    if (error) {
                        ...
                        /* si la validacion es satisfactoria, emitimos un evento al componente payment-method-create-premium con el token que nos devuelve stripe */

                        Livewire.emit('paymentMethodCreatePremium',setupIntent.payment_method)
                    }
                });
            }
        </script>
